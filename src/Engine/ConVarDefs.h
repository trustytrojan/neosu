...
CONVAR(cv_songbrowser_thumbnail_fade_in_duration, "osu_songbrowser_thumbnail_fade_in_duration", 0.1f,
                                                 FCVAR_BANCHO_COMPATIBLE);
CONVAR(cv_sort_skins_cleaned, "sort_skins_cleaned", false, FCVAR_BANCHO_COMPATIBLE, "set to true to sort skins alphabetically, ignoring special characters at the start (not like stable)");
...
CONVAR(cv_user_include_relax_and_autopilot_for_stats, "osu_user_include_relax_and_autopilot_for_stats", false,
                                                     FCVAR_BANCHO_COMPATIBLE);
CONVAR(cv_version, "osu_version", PACKAGE_VERSION, FCVAR_BANCHO_COMPATIBLE | FCVAR_HIDDEN);
