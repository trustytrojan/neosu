...
CONVAR(autopilot_snapping_strength, 
...
CONVAR(background_image_eviction_delay_frames, 
...
CONVAR(background_image_eviction_delay_seconds, 
...
CONVAR(background_image_loading_delay, 
...
CONVAR(beatmap_max_num_hitobjects, 
...
CONVAR(beatmap_preview_mods_live, 
...
CONVAR(cursor_ripple_anim_end_scale, "osu_cursor_ripple_anim_end_scale", 0.5f, FCVAR_BANCHO_COMPATIBLE,
                                       "end size multiplier");
CONVAR(cursor_ripple_anim_start_fadeout_delay, 
...
CONVAR(cursor_trail_smooth_div, 
...
CONVAR(drain_kill_notification_duration, 
...
CONVAR(fposu_zoom_toggle, "fposu_zoom_toggle", false, FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(hitobject_fade_in_time, "osu_hitobject_fade_in_time", 400, FCVAR_LOCKED | FCVAR_GAMEPLAY,
                                 "in milliseconds (!)");
CONVAR(hitobject_fade_out_time, "osu_hitobject_fade_out_time", 0.293f, FCVAR_LOCKED | FCVAR_GAMEPLAY,
                                  "in seconds (!)");
CONVAR(hitobject_fade_out_time_speed_multiplier_min, 
...
CONVAR(hitobject_hittable_dim_duration, "osu_hitobject_hittable_dim_duration", 100, FCVAR_BANCHO_COMPATIBLE,
                                          "in milliseconds (!)");
CONVAR(hitobject_hittable_dim_start_percent, 
...
CONVAR(hitresult_delta_colorize_early_r, "osu_hitresult_delta_colorize_early_r", 255, FCVAR_BANCHO_COMPATIBLE,
                                           "from 0 to 255");
CONVAR(hitresult_delta_colorize_interpolate, "osu_hitresult_delta_colorize_interpolate", true,
                                               FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(hitresult_delta_colorize_late_r, "osu_hitresult_delta_colorize_late_r", 0, FCVAR_BANCHO_COMPATIBLE,
                                          "from 0 to 255");
CONVAR(hitresult_delta_colorize_multiplier, 
...
CONVAR(hud_hiterrorbar_entry_miss_fade_time, "osu_hud_hiterrorbar_entry_miss_fade_time", 4.0f,
                                               FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(hud_hiterrorbar_offset_right_percent, "osu_hud_hiterrorbar_offset_right_percent", 0.0f,
                                               FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(hud_hiterrorbar_width_percent_with_misswindow, "osu_hud_hiterrorbar_width_percent_with_misswindow", 0.4f,
                                                        FCVAR_BANCHO_COMPATIBLE);
CONVAR(hud_inputoverlay_anim_color_duration, "osu_hud_inputoverlay_anim_color_duration", 0.1f,
                                               FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(hud_scrubbing_timeline_strains_aim_color_r, "osu_hud_scrubbing_timeline_strains_aim_color_r", 0,
                                                     FCVAR_BANCHO_COMPATIBLE);
CONVAR(hud_scrubbing_timeline_strains_alpha, "osu_hud_scrubbing_timeline_strains_alpha", 0.4f,
                                               FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(hud_statistics_hitwindow300_offset_x, "osu_hud_statistics_hitwindow300_offset_x", 0.0f,
                                               FCVAR_BANCHO_COMPATIBLE);
CONVAR(hud_statistics_hitwindow300_offset_y, "osu_hud_statistics_hitwindow300_offset_y", 0.0f,
                                               FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(hud_statistics_sliderbreaks_offset_x, "osu_hud_statistics_sliderbreaks_offset_x", 0.0f,
                                               FCVAR_BANCHO_COMPATIBLE);
CONVAR(hud_statistics_sliderbreaks_offset_y, "osu_hud_statistics_sliderbreaks_offset_y", 0.0f,
                                               FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(instafade_sliders, "instafade_sliders", false, FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(main_menu_banner_ifupdatedfromoldversion_le3300_text, 
    "osu_main_menu_banner_ifupdatedfromoldversion_le3300_text", "", FCVAR_BANCHO_COMPATIBLE);
CONVAR(main_menu_banner_ifupdatedfromoldversion_le3303_text, 
...
CONVAR(mod_approach_different_initial_size, 
...
CONVAR(mod_approach_different_style, 
...
CONVAR(mod_fposu_sound_panning, "osu_mod_fposu_sound_panning", false, FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(mod_hd_circle_fadein_end_percent, 
...
CONVAR(mod_hd_circle_fadein_start_percent, 
...
CONVAR(mod_hd_circle_fadeout_end_percent, 
...
CONVAR(mod_hd_circle_fadeout_start_percent, 
...
CONVAR(mod_mafham_render_livesize, 
...
CONVAR(options_slider_preview_use_legacy_renderer, 
...
CONVAR(playfield_border_top_percent, "osu_playfield_border_top_percent", 0.117f,
                                       FCVAR_BANCHO_COMPATIBLE | FCVAR_GAMEPLAY);
CONVAR(playfield_mirror_horizontal, "osu_playfield_mirror_horizontal", false,
                                      FCVAR_BANCHO_COMPATIBLE | FCVAR_GAMEPLAY);
...
CONVAR(rankingscreen_topbar_height_percent, "osu_rankingscreen_topbar_height_percent", 0.785f,
                                              FCVAR_BANCHO_COMPATIBLE);
CONVAR(relax_offset, 
...
CONVAR(restart_sound_engine_before_playing, 
...
CONVAR(skin_hd, "osu_skin_hd", true, FCVAR_BANCHO_COMPATIBLE,
...
CONVAR(skin_use_skin_hitsounds, 
...
CONVAR(slider_body_fade_out_time_multiplier, "osu_slider_body_fade_out_time_multiplier", 1.0f,
...
CONVAR(slider_body_smoothsnake, 
...
CONVAR(slider_curve_points_separation, 
...
CONVAR(slider_debug_draw_square_vao, 
...
CONVAR(slider_followcircle_fadeout_scale_time, "osu_slider_followcircle_fadeout_scale_time", 0.25f,
                                                 FCVAR_BANCHO_COMPATIBLE);
CONVAR(slider_followcircle_tick_pulse_scale, "osu_slider_followcircle_tick_pulse_scale", 0.1f,
                                               FCVAR_BANCHO_COMPATIBLE);
CONVAR(slider_followcircle_tick_pulse_time, "osu_slider_followcircle_tick_pulse_time", 0.2f, FCVAR_BANCHO_COMPATIBLE);
CONVAR(slider_legacy_use_baked_vao, 
...
CONVAR(slider_reverse_arrow_black_threshold, 
...
CONVAR(songbrowser_thumbnail_fade_in_duration, "osu_songbrowser_thumbnail_fade_in_duration", 0.1f,
                                                 FCVAR_BANCHO_COMPATIBLE);
CONVAR(sort_skins_cleaned, "sort_skins_cleaned", false, FCVAR_BANCHO_COMPATIBLE, "set to true to sort skins alphabetically, ignoring special characters at the start (not like stable)");
...
CONVAR(stars_slider_curve_points_separation, 
...
CONVAR(tablet_sensitivity_ignore, "tablet_sensitivity_ignore", Env::cfg(OS::WINDOWS) ? false : true, FCVAR_BANCHO_COMPATIBLE);
...
CONVAR(ui_scale_to_dpi_minimum_height, 
...
CONVAR(ui_scale_to_dpi_minimum_width, 
