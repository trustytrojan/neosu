...
private:
	...
	[[nodiscard]] int getMaxFramesInFlight() const { return this->iMaxFramesInFlight; }        // get current maximum frames in flight
	[[nodiscard]] int getCurrentFramesInFlight() const { return this->frameSyncQueue.size(); } // get actual frames in flight
