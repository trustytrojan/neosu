...
OpenGLStateCache &OpenGLStateCache::getInstance() {
    if(s_instance == nullptr) s_instance = new OpenGLStateCache();
...
void OpenGLStateCache::refresh() {
    ...
    glGetIntegerv(GL_VIEWPORT, this->iViewport.data());
}

void OpenGLStateCache::setCurrentProgram(int program) { this->iCurrentProgram = program; }

int OpenGLStateCache::getCurrentProgram() const { return this->iCurrentProgram; }

void OpenGLStateCache::setCurrentFramebuffer(int framebuffer) { this->iCurrentFramebuffer = framebuffer; }

int OpenGLStateCache::getCurrentFramebuffer() const { return this->iCurrentFramebuffer; }
