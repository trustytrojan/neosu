...
OpenGLES2VertexArrayObject::OpenGLES2VertexArrayObject(Graphics::PRIMITIVE primitive, Graphics::USAGE_TYPE usage,
...
void OpenGLES2VertexArrayObject::draw() {
    ...
    OpenGLES2Interface *g = (OpenGLES2Interface *)g;

    // bind
    {
        // NOTE: since opengl es 2.0 doesn't support vaos, we have to update glVertexAttribPointer for every buffer
