...
void WinSWGraphicsInterface::endScene() {
    ...
    if(backBuffer != NULL) {
        ...
        StretchDIBits(m_hdc, 0, 0, (int)rendererResolution.x, (int)rendererResolution.y, 0, 0,
                      (int)rendererResolution.x, (int)rendererResolution.y, backBuffer, &bminfo, DIB_RGB_COLORS,
                      SRCCOPY);
    }
}
