...
MacOSSDLEnvironment::MacOSSDLEnvironment() : SDLEnvironment(NULL) { m_environment = new MacOSEnvironment(NULL); }
...
void MacOSSDLEnvironment::openURLInDefaultBrowser(UString url) { m_environment->openURLInDefaultBrowser(url); }

UString MacOSSDLEnvironment::getUsername() { return m_environment->getUsername(); }

UString MacOSSDLEnvironment::getUserDataPath() { return m_environment->getUserDataPath(); }
...
std::vector<UString> MacOSSDLEnvironment::getLogicalDrives() { return m_environment->getLogicalDrives(); }
