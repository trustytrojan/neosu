...
void VertexArrayObject::addNormal(Vector3 normal) { m_normals.push_back(normal); }

void VertexArrayObject::addNormal(float x, float y, float z) { m_normals.push_back(Vector3(x, y, z)); }

void VertexArrayObject::addColor(Color color) { m_colors.push_back(color); }
...
void VertexArrayObject::setType(Graphics::PRIMITIVE primitive) { m_primitive = primitive; }
