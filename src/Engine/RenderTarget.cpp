...
void RenderTarget::rebuild(int x, int y, int width, int height) { rebuild(x, y, width, height, m_multiSampleType); }

void RenderTarget::rebuild(int width, int height) { rebuild(m_vPos.x, m_vPos.y, width, height, m_multiSampleType); }
