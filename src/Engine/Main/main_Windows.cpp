...
ConVar fps_max_yield("fps_max_yield", false, FCVAR_NONE, "always release rest of timeslice once per frame (call scheduler via sleep(0))");
...
ConVar fps_unlimited_yield("fps_unlimited_yield", false, FCVAR_NONE, "always release rest of timeslice once per frame (call scheduler via sleep(0)), even if unlimited fps are enabled");
