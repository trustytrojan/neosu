...
class CBaseUIContainerVerticalBox : public CBaseUIContainerBase {
   public:
    ...
    CBaseUIContainerVerticalBox *setPadding(float padding) {
        m_padding = padding;
        return this;
    }
    CBaseUIContainerVerticalBox *setMargin(float marginX, float marginY) {
        m_vMargin.x = marginX;
        m_vMargin.y = marginY;
        return this;
    }
    CBaseUIContainerVerticalBox *setMarginX(float marginX) {
        m_vMargin.x = marginX;
        return this;
    }
    CBaseUIContainerVerticalBox *setMarginY(float marginY) {
        m_vMargin.y = marginY;
        return this;
    }
    CBaseUIContainerVerticalBox *setMargin(Vector2 margin) {
        m_vMargin = margin;
        return this;
    }
    CBaseUIContainerVerticalBox *setMargin(float margin) {
        m_vMargin.x = m_vMargin.y = margin;
        return this;
    }
    CBaseUIContainerVerticalBox *setHeightOverride(bool heightOverride) {
        m_bHeightOverride = heightOverride;
        return this;
    }
