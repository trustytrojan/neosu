...
OsuUIContextMenuButton::OsuUIContextMenuButton(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name,
                                               UString text, int id)
...
void OsuUIContextMenuButton::setTooltipText(UString text) { m_tooltipTextLines = text.split("\n"); }

OsuUIContextMenuTextbox::OsuUIContextMenuTextbox(float xPos, float yPos, float xSize, float ySize, UString name, int id)
    : CBaseUITextbox(xPos, yPos, xSize, ySize, name) {
    m_iID = id;
}

OsuUIContextMenu::OsuUIContextMenu(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name,
...
OsuUIContextMenuButton *OsuUIContextMenu::addButton(UString text, int id) {
    ...
    OsuUIContextMenuButton *button =
        new OsuUIContextMenuButton(m_osu, margin, m_iYCounter + margin, 0, buttonHeight, text, text, id);
    {
...
OsuUIContextMenuTextbox *OsuUIContextMenu::addTextbox(UString text, int id) {
    ...
    OsuUIContextMenuTextbox *textbox =
        new OsuUIContextMenuTextbox(margin, m_iYCounter + margin, 0, buttonHeight, text, id);
    {
...
void OsuUIContextMenu::onResized() { setSize(m_vSize); }
...
void OsuUIContextMenu::onMouseDownOutside() { setVisible2(false); }
