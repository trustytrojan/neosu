...
OsuUIButton::OsuUIButton(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name, UString text)
...
void OsuUIButton::onMouseInside() { m_fBrightness = 1.0f; }

void OsuUIButton::onMouseOutside() { m_fBrightness = 0.85f; }
...
void OsuUIButton::setTooltipText(UString text) { m_tooltipTextLines = text.split("\n"); }
