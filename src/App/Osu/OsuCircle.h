...
class OsuCircle : public OsuHitObject {
   public:
    ...
    static void draw3DApproachCircle(Graphics *g, OsuBeatmapStandard *beatmap, const OsuHitObject *hitObject,
    ...
    static void draw3DCircle(Graphics *g, OsuBeatmapStandard *beatmap, const OsuHitObject *hitObject,
    ...
    static void drawCircle(Graphics *g, OsuSkin *skin, Vector2 pos, float hitcircleDiameter, float numberScale,
                           ...
                           bool overrideHDApproachCircle = false);
    static void draw3DCircle(Graphics *g, OsuModFPoSu *fposu, const Matrix4 &baseScale, OsuSkin *skin, Vector3 pos,
    ...
    static void drawSliderStartCircle(Graphics *g, OsuBeatmapStandard *beatmap, Vector2 rawPos, int number,
                                      ...
                                      float alpha, float numberAlpha, bool drawNumber = true,
                                      bool overrideHDApproachCircle = false);
    static void draw3DSliderStartCircle(Graphics *g, OsuBeatmapStandard *beatmap, const OsuHitObject *hitObject,
                                        const Matrix4 &baseScale, Vector2 rawPos, int number, int colorCounter,
                                        int colorOffset, float colorRGBMultiplier, float approachScale, float alpha,
                                        float numberAlpha, bool drawNumber = true,
                                        bool overrideHDApproachCircle = false);
    static void drawSliderStartCircle(Graphics *g, OsuSkin *skin, Vector2 pos, float hitcircleDiameter,
                                      ...
                                      bool overrideHDApproachCircle = false);
    static void draw3DSliderStartCircle(Graphics *g, OsuModFPoSu *fposu, const Matrix4 &baseScale, OsuSkin *skin,
                                        Vector3 pos, float rawHitcircleDiameter, float numberScale,
                                        float hitcircleOverlapScale, int number, int colorCounter = 0,
                                        int colorOffset = 0, float colorRGBMultiplier = 1.0f,
                                        float approachScale = 1.0f, float alpha = 1.0f, float numberAlpha = 1.0f,
                                        bool drawNumber = true, bool overrideHDApproachCircle = false);
    static void drawSliderEndCircle(Graphics *g, OsuBeatmapStandard *beatmap, Vector2 rawPos, int number,
                                    int colorCounter, int colorOffset, float colorRGBMultiplier, float approachScale,
                                    float alpha, float numberAlpha, bool drawNumber = true,
                                    bool overrideHDApproachCircle = false);
    static void draw3DSliderEndCircle(Graphics *g, OsuBeatmapStandard *beatmap, const OsuHitObject *hitObject,
                                      const Matrix4 &baseScale, Vector2 rawPos, int number, int colorCounter,
                                      int colorOffset, float colorRGBMultiplier, float approachScale, float alpha,
                                      float numberAlpha, bool drawNumber = true, bool overrideHDApproachCircle = false);
    static void drawSliderEndCircle(Graphics *g, OsuSkin *skin, Vector2 pos, float hitcircleDiameter, float numberScale,
                                    ...
                                    bool overrideHDApproachCircle = false);
    static void draw3DSliderEndCircle(Graphics *g, OsuModFPoSu *fposu, const Matrix4 &baseScale, OsuSkin *skin,
                                      Vector3 pos, float rawHitcircleDiameter, float numberScale, float overlapScale,
                                      int number = 0, int colorCounter = 0, int colorOffset = 0,
                                      float colorRGBMultiplier = 1.0f, float approachScale = 1.0f, float alpha = 1.0f,
                                      float numberAlpha = 1.0f, bool drawNumber = true,
                                      bool overrideHDApproachCircle = false);
    ...
    static void draw3DApproachCircle(Graphics *g, OsuModFPoSu *fposu, const Matrix4 &baseScale, OsuSkin *skin,
    ...
    static void draw3DHitCircleOverlay(Graphics *g, OsuModFPoSu *fposu, const Matrix4 &baseScale,
    ...
    static void drawHitCircle(Graphics *g, Image *hitCircleImage, Vector2 pos, Color comboColor, float circleImageScale,
                              float alpha);
    static void draw3DHitCircle(Graphics *g, OsuModFPoSu *fposu, OsuSkin *skin, const Matrix4 &baseScale,
    ...
    static void draw3DHitCircleNumber(Graphics *g, OsuSkin *skin, float numberScale, float overlapScale, Vector3 pos,
                                      int number, float numberAlpha, float colorRGBMultiplier);
