...
class OsuOptionsMenuSkinPreviewElement : public CBaseUIElement {
   public:
    OsuOptionsMenuSkinPreviewElement(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name)
    ...
    virtual void draw(Graphics *g) {
        ...
        if(m_iMode == 0) {
            ...
            OsuCircle::drawCircle(g, m_osu->getSkin(),
            ...
            OsuCircle::drawHitResult(g, m_osu->getSkin(), hitcircleDiameter, hitcircleDiameter,
                                     m_vPos + Vector2(0, m_vSize.y / 2) + Vector2(m_vSize.x * (2.0f / 5.0f), 0.0f),
                                     OsuScore::HIT::HIT_100, 0.45f, 0.33f);
            OsuCircle::drawHitResult(g, m_osu->getSkin(), hitcircleDiameter, hitcircleDiameter,
                                     m_vPos + Vector2(0, m_vSize.y / 2) + Vector2(m_vSize.x * (3.0f / 5.0f), 0.0f),
                                     OsuScore::HIT::HIT_50, 0.45f, 0.66f);
            OsuCircle::drawHitResult(g, m_osu->getSkin(), hitcircleDiameter, hitcircleDiameter,
                                     m_vPos + Vector2(0, m_vSize.y / 2) + Vector2(m_vSize.x * (4.0f / 5.0f), 0.0f),
                                     OsuScore::HIT::HIT_MISS, 0.45f, 1.0f);
            OsuCircle::drawApproachCircle(g, m_osu->getSkin(),
                                          m_vPos + Vector2(0, m_vSize.y / 2) + Vector2(m_vSize.x * (1.0f / 5.0f), 0.0f),
...
class OsuOptionsMenuSliderPreviewElement : public CBaseUIElement {
   public:
    OsuOptionsMenuSliderPreviewElement(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name)
        : CBaseUIElement(xPos, yPos, xSize, ySize, name) {
        m_osu = osu;
        ...
        */
        ...
        if(points.size() > 0) {
            ...
            // draw slider body
            {
                ...
                if(m_bDrawSliderHack) {
                    if(useLegacyRenderer)
                        OsuSliderRenderer::draw(g, m_osu, points, emptyVector, hitcircleDiameter, 0, 1,
                        ...
                        if(m_vao == NULL || length != m_fPrevLength) {
                            ...
                            if(m_vao == NULL)
                                m_vao = OsuSliderRenderer::generateVAO(m_osu, points, hitcircleDiameter,
                                                                       Vector3(0, 0, 0), false);
                        }
                        OsuSliderRenderer::draw(g, m_osu, m_vao, emptyVector, m_vPos, 1, hitcircleDiameter, 0, 1,
                                                m_osu->getSkin()->getComboColorForCounter(420, 0));
                    }
                }
            }
            ...
            // and slider head/tail circles
            {
                ...
                OsuCircle::drawSliderStartCircle(
                ...
                OsuCircle::drawSliderEndCircle(
                    g, m_osu->getSkin(), points[points.size() - 1] + (!useLegacyRenderer ? m_vPos : Vector2(0, 0)),
...
class OsuOptionsMenuKeyBindLabel : public CBaseUILabel {
   public:
    OsuOptionsMenuKeyBindLabel(float xPos, float yPos, float xSize, float ySize, UString name, UString text,
...
class OsuOptionsMenuKeyBindButton : public OsuUIButton {
   public:
    OsuOptionsMenuKeyBindButton(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name, UString text)
        : OsuUIButton(osu, xPos, yPos, xSize, ySize, name, text) {
...
class OsuOptionsMenuCategoryButton : public CBaseUIButton {
   public:
    OsuOptionsMenuCategoryButton(CBaseUIElement *section, float xPos, float yPos, float xSize, float ySize,
...
class OsuOptionsMenuResetButton : public CBaseUIButton {
   public:
    OsuOptionsMenuResetButton(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name, UString text)
        : CBaseUIButton(xPos, yPos, xSize, ySize, name, text) {
        m_osu = osu;
        m_fAnim = 1.0f;
    }

    virtual ~OsuOptionsMenuResetButton() { anim->deleteExistingAnimation(&m_fAnim); }
...
OsuOptionsMenu::OsuOptionsMenu(Osu *osu) : OsuScreenBackable(osu) {
    ...
    convar->getConVarByName("osu_skin_use_skin_hitsounds")
        ->setCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onUseSkinsSoundSamplesChange));
    ...
    manuallyManageBeatmapsButton->setClickCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onManuallyManageBeatmapsClicked));
    ...
    addSkinPreview();
    {
        ...
        ((CBaseUIButton *)m_skinSelectLocalButton)
            ->setClickCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSkinSelect));

        OPTIONS_ELEMENT skinReload = addButtonButton("Reload Skin", "Random Skin");
        ((OsuUIButton *)skinReload.elements[0])
            ->setClickCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSkinReload));
        ((OsuUIButton *)skinReload.elements[0])->setTooltipText("(CTRL + ALT + S)");
        ((OsuUIButton *)skinReload.elements[1])
            ->setClickCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSkinRandom));
        ((OsuUIButton *)skinReload.elements[1])
            ->setTooltipText(
    ...
    if(env->getOS() == Environment::OS::OS_WINDOWS) {
        ...
        addCheckbox("Map Absolute Raw Input to Window", convar->getConVarByName("mouse_raw_input_absolute_to_window"))
            ->setChangeCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onRawInputToAbsoluteWindowChange));
    }
    ...
    addSlider("Stick Deadzone:", 0.0f, 0.95f, convar->getConVarByName("sdl_joystick0_deadzone"))
        ->setKeyDelta(0.01f)
        ->setChangeCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangePercent));
    ...
    resetAllKeyBindingsButton->setClickCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onKeyBindingsResetAllPressed));
    ...
    addKeyBindButton("Toggle Mod Selection Screen", &OsuKeyBindings::TOGGLE_MODSELECT)
        ->setTooltipText("(F1 can not be unbound. This is just an additional key.)");
    addKeyBindButton("Random Beatmap", &OsuKeyBindings::RANDOM_BEATMAP)
    ...
    ((CBaseUIButton *)drainSelect.elements[0])
        ->setClickCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onHPDrainSelect));
    ...
    m_hpDrainSelectResetButton->setClickCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onHPDrainSelectResetClicked));
    addLabel("");
    ...
    ((CBaseUIButton *)notelockSelect.elements[0])
        ->setClickCallback(fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onNotelockSelect));
    ...
    m_notelockSelectResetButton->setClickCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onNotelockSelectResetClicked));
    addLabel("");
    ...
    m_hudAccuracyScaleSlider->setChangeCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangePercent));
    ...
    m_hudScoreBarScaleSlider->setChangeCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangePercent));
    ...
    m_statisticsOverlayXOffsetSlider->setChangeCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangeInt));
    ...
    m_playfieldBorderSizeSlider->setChangeCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangeInt));
    ...
    zoomedFovSlider->setChangeCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onSliderChangeTwoDecimalPlaces));
    ...
    if(env->getOS() == Environment::OS::OS_WINDOWS) {
        ...
        cm360CalculatorLinkButton->setClickCallback(
            fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onCM360CalculatorLinkClicked));
    ...
    resetAllSettingsButton->setClickCallback(
        fastdelegate::MakeDelegate(this, &OsuOptionsMenu::onResetEverythingClicked));
    ...
    if(sectionOnline != NULL) addCategory(sectionOnline, OsuIcons::GLOBE);
...
void OsuOptionsMenu::draw(Graphics *g) {
    ...
    if(m_hudSizeSlider->isActive() || m_hudComboScaleSlider->isActive() || m_hudScoreScaleSlider->isActive() ||
       ...
       m_statisticsOverlayXOffsetSlider->isActive() || m_statisticsOverlayYOffsetSlider->isActive()) {
        ...
        m_osu->getHUD()->drawPlayfieldBorder(g, OsuGameRules::getPlayfieldCenter(m_osu),
                                             OsuGameRules::getPlayfieldSize(m_osu), 100);
    } else
        OsuScreenBackable::draw(g);
...
void OsuOptionsMenu::setUsername(UString username) { m_nameTextbox->setText(username); }
...
void OsuOptionsMenu::onSkinReload() { m_osu->reloadSkin(); }
            ...
            if(m_elements[i].elements[e] == button) {
                if(m_elements[i].cvar != NULL) {
                    ...
                    m_osu->getNotificationOverlay()->setDisallowWaitForKeyLeftClick(
                        !(dynamic_cast<OsuOptionsMenuKeyBindButton *>(button)->isLeftMouseClickBindingAllowed()));
                }
                break;
            }
        }
...
OsuOptionsMenu::OPTIONS_ELEMENT OsuOptionsMenu::addButtonButtonLabel(UString text1, UString text2, UString labelText,
...
OsuOptionsMenuKeyBindButton *OsuOptionsMenu::addKeyBindButton(UString text, ConVar *cvar) {
    ...
    OsuOptionsMenuKeyBindButton *bindButton =
        new OsuOptionsMenuKeyBindButton(m_osu, 0, 0, m_options->getSize().x, 50, text, text);
    ...
    OsuOptionsMenuKeyBindLabel *label =
        new OsuOptionsMenuKeyBindLabel(0, 0, m_options->getSize().x, 50, "", "", cvar, bindButton);
    label->setDrawFrame(false);
    label->setDrawBackground(false);
    m_options->getContainer()->addBaseUIElement(label);
...
CBaseUICheckbox *OsuOptionsMenu::addCheckbox(UString text, ConVar *cvar) { return addCheckbox(text, "", cvar); }
...
CBaseUIElement *OsuOptionsMenu::addSkinPreview() {
    CBaseUIElement *skinPreview =
        new OsuOptionsMenuSkinPreviewElement(m_osu, 0, 0, 0, 200, "skincirclenumberhitresultpreview");
