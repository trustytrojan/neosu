...
OsuUISlider::OsuUISlider(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name)
...
void OsuUISlider::draw(Graphics *g) {
    ...
    if(line1End > line1Start)
        g->drawLine((int)(line1Start), (int)(m_vPos.y + m_vSize.y / 2.0f + 1), (int)(line1End),
                    (int)(m_vPos.y + m_vSize.y / 2.0f + 1));
    if(line2End > line2Start)
        g->drawLine((int)(line2Start), (int)(m_vPos.y + m_vSize.y / 2.0f + 1), (int)(line2End),
                    (int)(m_vPos.y + m_vSize.y / 2.0f + 1));
