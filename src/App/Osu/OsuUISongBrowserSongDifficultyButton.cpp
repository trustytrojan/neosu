...
OsuUISongBrowserSongDifficultyButton::OsuUISongBrowserSongDifficultyButton(Osu *osu, OsuSongBrowser *songBrowser,
                                                                           ...
                                                                           UString name, OsuDatabaseBeatmap *diff2,
                                                                           OsuUISongBrowserSongButton *parentSongButton)
    : OsuUISongBrowserSongButton(osu, songBrowser, view, contextMenu, xPos, yPos, xSize, ySize, name, NULL) {
...
void OsuUISongBrowserSongDifficultyButton::onSelected(bool wasSelected, bool autoSelectBottomMostChild,
