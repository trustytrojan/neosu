...
Changelog::Changelog() : ScreenBackable() {
    ...
    v36_00.changes.push_back("- Added \"Actual Flashlight\" mod");
    v36_00.changes.push_back("- Added \"Rank Achieved\" sort option");
    v36_00.changes.push_back("- Added BPM song grouping");
    v36_00.changes.push_back("- Added keybind to open skin selection menu");
    v36_00.changes.push_back("- Added option to change pitch based on hit accuracy");
    v36_00.changes.push_back("- Added retry/watch buttons on score screen");
    v36_00.changes.push_back("- Added slider instafade setting");
    v36_00.changes.push_back("- Fixed \"Personal Best\" score button not being clickable");
    v36_00.changes.push_back("- Fixed local scores not saving avatar");
    v36_00.changes.push_back("- Fixed song buttons not always displaying best grade");
    v36_00.changes.push_back("- Fixed map settings (like local offset) not getting saved");
    v36_00.changes.push_back("- Fixed Nightcore getting auto-selected instead of Double Time in some cases");
    v36_00.changes.push_back("- Improved loudness normalization");
    v36_00.changes.push_back("- Merged pp calculation optimizations from McOsu");
    v36_00.changes.push_back("- Optimized database loading");
    v36_00.changes.push_back("- Removed custom HP drain (use nofail instead)");
    v36_00.changes.push_back("- Removed mandala mod, random mod");
    v36_00.changes.push_back("- Removed rosu-pp");
    v36_00.changes.push_back("- Updated osu! version to b20240820.1");
    v36_00.changes.push_back("- Linux: Fixed \"Skin.ini\" failing to load");
    v36_00.changes.push_back("- Windows: Fixed collections/maps/scores not getting saved");
