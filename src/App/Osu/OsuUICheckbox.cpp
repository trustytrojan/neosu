...
OsuUICheckbox::OsuUICheckbox(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name, UString text)
...
void OsuUICheckbox::setTooltipText(UString text) { m_tooltipTextLines = text.split("\n"); }
