...
OsuUISongBrowserButton::~OsuUISongBrowserButton() { deleteAnimations(); }
...
void OsuUISongBrowserButton::deselect() { m_bSelected = false; }

void OsuUISongBrowserButton::resetAnimations() { setMoveAwayState(MOVE_AWAY_STATE::MOVE_CENTER, false); }
