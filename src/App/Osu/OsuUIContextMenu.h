...
class OsuUIContextMenu : public CBaseUIScrollView {
   ...
   public:
    OsuUIContextMenu(Osu *osu, float xPos = 0, float yPos = 0, float xSize = 0, float ySize = 0, UString name = "",
...
class OsuUIContextMenuButton : public CBaseUIButton {
   public:
    OsuUIContextMenuButton(Osu *osu, float xPos, float yPos, float xSize, float ySize, UString name, UString text,
                           int id);
