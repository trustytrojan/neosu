...
OsuChangelog::OsuChangelog(Osu *osu) : OsuScreenBackable(osu)
{
	...
	alpha317.changes.push_back("- Fixed not being visible on peppy client when starting a match as host");
	...
	alpha317.changes.push_back("- Removed Steam Workshop button");
	alpha317.changes.push_back("");
	alpha317.changes.push_back("");
	alpha317.changes.push_back("34.00");
	alpha317.changes.push_back("- Added ability to connect to servers using Bancho protocol");
	alpha317.changes.push_back("- Added ability to see, join and play in multiplayer rooms");
	alpha317.changes.push_back("- Added online leaderboards");
	alpha317.changes.push_back("- Added chat");
	alpha317.changes.push_back("- Added automatic map downloads for multiplayer rooms");
	alpha317.changes.push_back("");
	alpha317.changes.push_back("");
	alpha317.changes.push_back("33.08");
