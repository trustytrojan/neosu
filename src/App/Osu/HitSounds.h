...
struct HitSamples {
    ...
    u8 normalSet = 0;           // sample set of the normal sound
    u8 additionSet = 0;         // sample set of the whistle, finish and clap sounds
    u8 volume = 0;              // volume of the sample, 1-100. if 0, use timing point volume instead
    i32 index = 0;              // index of the sample; if 0, use timing point sample index instead
